...
input_path = os.path.join(data_dir, "sample_tr.csv")
...
print(f"Training BERTopic on {len(docs)} Turkish articles...")

# Run BERTopic with Translated Seeds
seed_topic_list = [['protesto', 'gösteri', 'grev'], ['hükümet', 'siyasi'], ['demokrasi', 'reform'], ['küresel', 'uluslararası'], ['din', 'cami'], ['seçim', 'oy'], ['ekonomi', 'temel ihtiyaçlar'], ['darbe', 'askeri'], ['şiddet', 'iç savaş']]
...
print(f"--- FINAL VAR INPUT READY (TR) ---")
